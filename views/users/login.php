...
<body class="bg-light">
  <div class="container d-flex flex-column align-items-center justify-content-center" style="min-height: 100vh;">
    <div class="card p-4 shadow-sm w-100" style="max-width: 400px;">
      <h2 class="text-center mb-4">Bienvenido, inicia sesión con tu cuenta!</h2>
      <form>
        <div class="mb-3">
          <label for="username" class="form-label">Usuario</label>
          <input type="text" class="form-control" id="username" placeholder="@Ejemplo" />
        </div>
        <div class="mb-3">
      ...
      <p class="text-center mt-3">¿No tienes cuenta todavía? <a href="#">¡Crea una!</a></p>
    </div>
  </div>
</body>
</html>